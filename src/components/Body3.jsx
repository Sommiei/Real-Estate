...
<>
        ...
        <div className="w-[50px] h-[50px]  rounded-full left-[50%] absolute bg-gradient-to-br  from-[#4361EE] to-[#4361EE00]">  
         ...
         <div className="flex items-center justify-center  ">
            <div className="w-[320px] h-[340px] flex bg-white rounded-2xl justify-center items-center relative shadow-black">
                <img src="body2-img1.png" alt="" className="rounded-2xl w-[250px] shadow-gradient-to-br  from-[#FFFFFF] to-[#000000] brightness-50"/> 
            ...
            <div className="w-[320px] h-[340px] flex  bg-white rounded-2xl justify-center items-center relative">
                <img src="3rd-body-img.jpg" alt="" className="rounded-2xl w-[400px] h-[250px] shadow-from-[#FFFFFF] to-[#000000] brightness-50"/> 
    ...
    <div className="flex flex-row justify-center items-center gap-5 ">
        <div className="flex justify-center items-center relative">
            <img src="second-to-the-last-body3.jpg" alt="" className="rounded-2xl w-[400px] h-[250px] brightness-50" />
            <div className="absolute center mt-28 -ml-20">
        ...
        <div className="relative flex justify-center items-center">
            <img src="last-body3-img.jpg" alt=""className="rounded-2xl w-[500px] h-[250px] brightness-50" />
